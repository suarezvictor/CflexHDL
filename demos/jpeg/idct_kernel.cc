...
)
{
	...
	{
		uint8 b0 = o0 < -(128<<5) ? 0 : (o0 > (127<<5) ? 255 : (o0>>5)+128);
		uint8 b1 = o1 < -(128<<5) ? 0 : (o1 > (127<<5) ? 255 : (o1>>5)+128);
		uint8 b2 = o2 < -(128<<5) ? 0 : (o2 > (127<<5) ? 255 : (o2>>5)+128);
		uint8 b3 = o3 < -(128<<5) ? 0 : (o3 > (127<<5) ? 255 : (o3>>5)+128);
		uint8 b4 = o4 < -(128<<5) ? 0 : (o4 > (127<<5) ? 255 : (o4>>5)+128);
		uint8 b5 = o5 < -(128<<5) ? 0 : (o5 > (127<<5) ? 255 : (o5>>5)+128);
		uint8 b6 = o6 < -(128<<5) ? 0 : (o6 > (127<<5) ? 255 : (o6>>5)+128);
		uint8 b7 = o7 < -(128<<5) ? 0 : (o7 > (127<<5) ? 255 : (o7>>5)+128);
